  ...
  return (
    <section id="trusted-clients" className="mt-24 container mx-auto px-6 lg:px-2" aria-labelledby="client-section-heading">
      <h2 
        ...
        className="text-3xl md:text-4xl font-semibold tracking-tight text-gray-900 text-center mb-16"
      >
        <span className="relative inline-block">
          <span className="relative z-10">Trusted by Leading Organizations</span>
          <span className="absolute bottom-2 left-0 w-full h-2 bg-indigo-100 -z-10 transform skew-x-3"></span>
        </span>
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        >
          <div className="flex items-center mb-6">
            <BuildingOfficeIcon className="h-8 w-8 text-indigo-600 mr-3" aria-hidden="true" />
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-600 to-indigo-400">
              Corporates
            </h3>
          </div>
          <ul className="space-y-3 text-gray-800" role="list">
            {clients.map((client, index) => (
              <li
                key={index}
                className="flex items-center p-3 transition-all duration-200 hover:bg-gray-50 rounded-lg cursor-default group"
              >
        ...
        >
          <div className="flex items-center mb-6">
            <UsersIcon className="h-8 w-8 text-teal-600 mr-3" aria-hidden="true" />
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-400">
              Organizations
            </h3>
          </div>
          <ul className="space-y-3 text-gray-800" role="list">
        ...
        >
          <div className="flex items-center mb-6">
            <TvIcon className="h-8 w-8 text-teal-600 mr-3" aria-hidden="true" />
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-400">
              Media Presence
            </h3>
          </div>
        ...
        >
          <div className="flex items-center mb-6">
            <AcademicCapIcon className="h-8 w-8 text-teal-600 mr-3" aria-hidden="true" />
            <h3 className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-600 to-teal-400">
              Educator
            </h3>
          </div>
      ...
      <div className="mt-20 grid grid-cols-2 md:grid-cols-4 gap-6 text-center" data-aos="fade-up">
        <div className="p-4 bg-white rounded-xl shadow-md">
          ...
          <p className="text-gray-600 mt-1">Corporates</p>
        </div>
        <div className="p-4 bg-white rounded-xl shadow-md">
          <p className="text-4xl font-bold text-teal-600">{organizations.length}+</p>
          <p className="text-gray-600 mt-1">Organizations</p>
        </div>
        <div className="p-4 bg-white rounded-xl shadow-md">
          <p className="text-4xl font-bold text-indigo-600">{educationalInstitutions.length}+</p>
          <p className="text-gray-600 mt-1">Educational Institutions</p>
        </div>
        <div className="p-4 bg-white rounded-xl shadow-md">
          <p className="text-4xl font-bold text-teal-600">{mediaPresence.length}</p>
          <p className="text-gray-600 mt-1">Media Features</p>
        </div>
      </div>
