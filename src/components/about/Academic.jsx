                ...
                <div className="relative mx-auto max-w-3xl">
                    ...
                    {education.map((edu, index) => (
                        <div key={index} className="relative pl-12 mb-12 last:mb-0">
                            {/* Timeline dot */}
                            <div className="absolute left-0 w-8 h-8 bg-teal-600 rounded-full border-4 border-white"></div>
                            
                            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
                                <span className="inline-block px-3 py-1 mb-4 text-sm font-semibold text-teal-600 bg-teal-50 rounded-full">
                                    {edu.year}
                                </span>
