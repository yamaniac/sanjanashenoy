        ...
        <>
            ...
            <div className="max-w-4xl mx-auto px-4 py-8 mt-20">
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-semibold mb-4 dark:text-white">General Information</h2>
                ...
                {/* Liability Section */}
                <section className="mb-8">
                    <h2 className="text-xl font-semibold mb-4 dark:text-white">Limitation of Liability</h2>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-semibold mb-4 dark:text-white">External Links</h2>
                ...
                <section className="mb-8">
                    <h2 className="text-xl font-semibold mb-4 dark:text-white">Professional Disclaimer</h2>
                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
