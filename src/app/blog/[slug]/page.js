        ...
        <main className="container mx-auto px-4 sm:px-6 py-8 pt-5">
          ...
          <div className="flex gap-16">
            ...
            <div className="flex-1 max-w-[1100px]">
              ...
              <Link
                href="/blog"
                className="inline-flex items-center text-teal-700 hover:text-teal-800 mb-12 text-lg"
              >
                <svg
              ...
              <header className="mb-8 md:mb-12">
                <h1 className="text-4xl md:text-6xl font-bold text-gray-800 mb-6 leading-tight article-title">
                  {post.title}
                </h1>
                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex flex-col">
                      <Link 
                        ...
                        className="text-lg font-medium hover:text-teal-700 text-gray-900"
                      >
                        {AUTHOR_INFO.name}
                      </Link>
                ...
                <div className="flex flex-wrap items-center text-gray-700 text-sm mb-6 gap-2">
                ...
                {post.tags && (
                  <div className="flex flex-wrap gap-2">
                    ...
                    {post.tags.length > 3 && (
                      <div className="relative group">
                        <span
                          className="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm font-medium cursor-help"
                        >
